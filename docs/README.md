...
| Configure external research data or OpenBB | [data-sources-and-openbb.md](./data-sources-and-openbb.md) | [research-memory-and-artifacts.md](./research-memory-and-artifacts.md), [safety-policy-and-execution.md](./safety-policy-and-execution.md) |
...
| [data-sources-and-openbb.md](./data-sources-and-openbb.md) | External-data acquisition order, supported OpenBB setup, provider credential references, official-source fallback, and source quality. |
...
| Research or decision memory, source snapshots, Data Needs and acquisition receipts, Datasets, external source routing, OpenBB, ResearchSpec/replay/ExperimentRun, forecast/calibration ledgers, postmortem lessons, search indexes, readiness labels, artifact paths, report quality, or markdown preview | `data-sources-and-openbb.md`, `decision-memory.md`, `research-memory-and-artifacts.md`, `improvement-loop.md`, `codex-native-orchestration.md` |
