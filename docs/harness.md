...
follow-up inputs, mirror session or child lifecycle, decide whether to delegate
or wait, validate generic shell syntax, constrain ordinary public retrieval,
reimplement Codex workdir policy,
