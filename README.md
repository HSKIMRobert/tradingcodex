...
| Enable optional OpenBB data access | [Data sources](https://monarchjuno.github.io/tradingcodex/data-sources.html) | In your terminal, project the direct upstream MCP with `tcx data-sources openbb enable`; OpenBB remains optional and is never installed during attach. |
