...
8. Use `./tcx subagents loop --run <workflow_run_id> --artifact <path>` to preview closed planner actions from artifacts when helpful. Queue means a compact pending task and delta brief; hooks do not recursively spawn subagents.
