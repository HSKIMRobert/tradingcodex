...
2. Use `{{TRADINGCODEX_WORKSPACE_LAUNCHER}} service status`, `{{TRADINGCODEX_WORKSPACE_LAUNCHER}} doctor --layer service`, and `{{TRADINGCODEX_WORKSPACE_LAUNCHER}} doctor --layer mcp` when status is stale or unhealthy.
