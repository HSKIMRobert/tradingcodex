...
urlpatterns = [
    ...
    path("integrations/mcp/", web.mcp_connectors, name="web-mcp-connectors"),
    path("integrations/mcp/connectors/create/", web.mcp_connector_create, name="web-mcp-connector-create"),
    path("integrations/mcp/connectors/<int:connector_id>/import/", web.mcp_connector_import, name="web-mcp-connector-import"),
