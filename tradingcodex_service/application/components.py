...
HARNESS_COMPONENTS: tuple[HarnessComponent, ...] = (
    HarnessComponent(
        ...
        surfaces={
            ...
            "services": ("agents", "analysis_runs", "mcp_runtime", "workbench"),
    ...
    HarnessComponent(
        ...
        surfaces={
            ...
            "services": ("analysis_runs", "agents", "workbench"),
    ...
    HarnessComponent(
        ...
        surfaces={
            ...
            "skills": ("tcx-workflow", "tcx-brain-create", "investment-brain-*"),
            "services": (
                "investment_brains",
                "agents",
                "analysis_runs",
    ...
    HarnessComponent(
        ...
        surfaces={
            ...
            "services": ("artifact_quality", "research", "workbench"),
    ...
    HarnessComponent(
        ...
        label="Build Turn Authorization",
        summary="Binds explicit root `$tcx-build` prompts to current-turn workspace mutations while leaving actual filesystem permission to Codex and financial execution to canonical service gates.",
        status="core",
        ...
        surfaces={
            ...
            "services": ("build_gateway", "startup_status", "brokers"),
        ...
        owned_capabilities=("build.turn_authorization", "build.self_update", "build.connector_scaffold"),
    ...
    HarnessComponent(
        ...
        summary="Stores and indexes principal-bound workspace research, quarantines malformed unmanaged markdown, and preserves file-native source snapshots.",
        status="core",
