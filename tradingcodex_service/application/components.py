...
HARNESS_COMPONENTS: tuple[HarnessComponent, ...] = (
    HarnessComponent(
        ...
        surfaces={
            ...
            "services": ("agents", "harness", "workbench"),
            "api": ("GET /api/workbench/", "POST /api/workbench/runs/", "POST /api/workbench/runs/{run_id}/follow-up/"),
            "frontend": ("Work", "Skills"),
            "files": (
                ".tradingcodex/generated/model-policy-manifest.json",
                ".tradingcodex/mainagent/workflows/*/web-run.json",
                ".tradingcodex/mainagent/workflows/*/web-run-events.jsonl",
            ),
            "templates": ("codex-base", "fixed-subagents", "repo-skills"),
            "tests": ("generated-workspace", "subagent-roster", "workbench-runner"),
        },
        depends_on=(),
    ...
    HarnessComponent(
        ...
        surfaces={
            ...
            "services": ("harness", "workflow_planner", "workflow_contracts", "workbench"),
            "api": ("GET /api/workbench/", "POST /api/workbench/preview/", "POST /api/workbench/runs/"),
            "mcp": ("record_workflow_plan",),
            "frontend": ("Work", "Skills"),
    ...
    HarnessComponent(
        ...
        surfaces={
            ...
            "services": ("harness", "workflow_state", "workbench"),
            "mcp": ("record_artifact_supervisor_loop",),
            "api": ("GET /api/workbench/runs/{run_id}",),
            "frontend": ("Work", "Library"),
    ...
    HarnessComponent(
        ...
        surfaces={
            "instructions": ("head-manager", "AGENTS"),
            "skills": ("plan-workflow", "tcx-workflow"),
    ...
    HarnessComponent(
        ...
        surfaces={
            ...
            "instructions": ("AGENTS",),
            "services": ("workbench", "log_safety"),
            "api": ("POST /api/workbench/preview/", "POST /api/workbench/runs/", "POST /api/workbench/runs/{run_id}/follow-up/"),
            "files": (".tradingcodex/mainagent/workflows/*/web-run-events.jsonl",),
            "frontend": ("Work",),
            "templates": ("information-barriers", "codex-base"),
            "tests": ("secret-warning", "generated-workspace", "workbench-redaction"),
        },
        depends_on=("audit-ledger",),
    ...
    HarnessComponent(
        ...
        surfaces={
            ...
            "skills": ("plan-workflow", "tcx-workflow", "strategy-creator"),
            "templates": ("repo-skills",),
