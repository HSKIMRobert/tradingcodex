...
HARNESS_COMPONENTS: tuple[HarnessComponent, ...] = (
    ...
    HarnessComponent(
        ...
        summary="Provides concise source-routing guidance and Snapshot/Dataset provenance without owning external providers.",
        status="core",
        tags=("guardrail.guidance", "improvement.workflow_quality"),
        surfaces={
            "services": ("datasets", "research"),
            "mcp_tools": (
            ...
            "instructions": ("AGENTS",),
            "templates": ("repo-skills", "fixed-subagents role TOML"),
            "roles": (
                "head-manager",
                "fundamental-analyst",
                "technical-analyst",
