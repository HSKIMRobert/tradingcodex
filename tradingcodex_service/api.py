...
@research_router.get("/source-snapshots/{snapshot_id}")
...
@research_router.post("/datasets/{dataset_id}/export")
def export_dataset(request, dataset_id: str, payload: DatasetExportRequest):
    return _call_mutation_tool(
        request,
        "export_dataset_csv",
        {"dataset_id": dataset_id, **_payload(payload)},
    )
