...
- TradingCodex MCP registry metadata, role-gated tool calls, viewer-only Codex capability inventory, JSON-RPC batch handling, and non-research DB tool-call ledger
...
dedicated maintainer `CODEX_HOME`, persistently trust all five generated
