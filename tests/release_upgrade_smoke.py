...
def assert_candidate_projection(
    ...
    *,
    ...
    require(config.get("web_search") == "live", "Head Manager planning reconnaissance must enable live web_search")
    ...
    if os.name == "nt":
        cache_base = Path(env["LOCALAPPDATA"]) / "TradingCodexScratch"
