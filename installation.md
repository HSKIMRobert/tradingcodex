...
documented exception to this generic BYOR posture: TradingCodex projects the
direct upstream MCP only to evidence roles, never bundles, installs, starts, or
manages it, and stores only environment-variable names. See
[Data Sources And OpenBB](docs/data-sources-and-openbb.md).
